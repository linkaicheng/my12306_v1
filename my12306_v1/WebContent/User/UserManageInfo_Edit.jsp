...
%>
	<form name="form1" method="post" action="<%=request.getContextPath()%>/User/user?action=user">
		...
		<table width="835" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td height="15" colspan="2"><img src="../img/line1.jpg"
					...
					<table width="700" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="350" align="left" class="text_cray1"><input
								name="textfield22" type="text" disabled="disabled" class="text_cray"
								id="textfield22" value="<%=user.getUsername() %>" readonly="readonly" /></td>
							<td width="230" colspan="-1" rowspan="7" align="center"
								background="../img/bg_point_write.gif" class="text_cray1"><img
								src="../img/photo_mr.jpg" width="120">
						...
						<tr>
							...
							<td align="left" class="text_cray1"><input name="textfield2"
								type="text" disabled="disabled" class="text_cray" id="textfield2"
								value="<%=user.getRealname()%>" readonly="readonly" /></td>
						</tr>
						<tr>
							<td width="20"></td>
							...
							<input type="radio"
								name="userDTO.sex_code" value="1" readonly="readonly"
								disabled="disabled" <%="1".equals(user.getSex())?"checked":"" %> /> 
								<span class="text_cray">
									<label>男</label>
									 <input type="radio" name="userDTO.sex_code"
									value="2" readonly="readonly" disabled="disabled" <%="2".equals(user.getSex())?"checked":"" %> /> <label>女</label>
						...
						<tr>
							...
							<td align="left" class="text_cray1"><input name="textfield2"
								type="text" disabled="disabled" class="text_cray" id="textfield2"
								value="<%=user.getCity().getProvince().getProvince() %>" readonly="readonly" /></td>
						</tr>
						<tr>
							<td width="20" align="center" class="text_red">*</td>
							...
							<td align="left" class="text_cray1"><input name="textfield2"
								type="text" disabled="disabled" class="text_cray" id="textfield2"
								value="<%=user.getCity().getCity() %>" readonly="readonly" /></td>
						</tr>
						<tr>
							<td width="20" align="center" class="text_red">*</td>
							...
							<td align="left" class="text_cray1"><input name="textfield2"
								type="text" disabled="disabled" class="text_cray" id="textfield2"
								value="<%=user.getCertType().getContent() %>" readonly="readonly" /></td>
						</tr>
						<tr>
							<td width="20" align="center" class="text_red">*</td>
							...
							<td align="left" class="text_cray1"><input name="textfield6"
								...
								id="textfield6" value="<%=user.getCert() %>" readonly="readonly" /></td>
						</tr>
						<tr>
							<td width="20" align="center" class="text_red">*</td>
							...
							<td colspan="2" align="left" class="text_cray1"><input
								...
								class="text_cray" id="textfield7" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(user.getBirthday())%>"
								/></td>
						</tr>
						<tr>
							...
							<td height="35" colspan="2" align="left" class="text_cray1"><select
								class="text_cray" id="passengerType" name="userType">
						...
						<tr>
							...
							<td height="80" colspan="2" align="left" class="text_cray1"><textarea
									name="content" rows="8" class="text_cray" style="width: 100%"><%=user.getContent() %></textarea>
							</td>
						</tr>
					</table>
					<br>
