  ...
  <tr>
    <td colspan="2"  ><table width="700" border="0" align="center" cellspacing="0">
      <tr>
        ...
        <td align="left" class="text_cray1"><input name="textfield4" type="text" disabled="disabled" class="text_cray" id="textfield4" value="<%=user.getUsername() %>" size="30" readonly="readonly"/></td>
      </tr>
      <tr>
        <td width="20" align="center" class="text_red">*</td>
        <td width="100" height="40" class="text_cray1">原密码：</td>
        <td align="left" class="text_cray1"><input name="passwordOld" type="text" class="text_cray" id="textfield5" size="30" /></td>
      </tr>
      <tr>
        <td width="20" align="center"  class="text_red">*</td>
        <td width="100" height="40" class="text_cray1">新密码：</td>
        <td align="left" class="text_cray1"><input name="password" type="text" class="text_cray" id="textfield6" size="30" /></td>
      </tr>
      <tr>
        <td width="20" align="center" class="text_red">*</td>
        <td width="100" height="40" class="text_cray1">确认新密码：</td>
        <td align="left" class="text_cray1"><input name="password2" type="text" class="text_cray" id="textfield7" size="30" /></td>
      </tr>
    </table>
      <br></td>
  </tr>
