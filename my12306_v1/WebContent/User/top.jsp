...
<!--
body {
	background-image: url(../img/bg_point_write.gif);
}
-->
</style></head>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="1411" colspan="2" background="../img/ny_top_img_bg.gif"><img src="../img/ny_top_img.gif" width="650" height="108"></td>
    </tr>
</table>
