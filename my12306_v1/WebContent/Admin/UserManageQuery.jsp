...
<body class="write_bg">
 <form name="form1" method="post" action="<%=request.getContextPath()%>/Admin/admin?action=list">
...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="15" colspan="2" align="center" ><img src="../img/line.jpg" width="850" height="6"></td>
  </tr>
  <tr>
...
<table width="835" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="835" background="../img/wb_01 (3).jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="5"></td>
        <td width="4%" height="25" align="left" class="text_cray1">姓名</td>
        <td width="11%" align="left" class="text_cray1"><label>
          <input name="realname" type="text" class="text_cray" style="width:80px" value="${sessionScope.listUser.realname }">
        </label></td>
        ...
        <td width="13%" align="left" class="text_cray1"><label>
          <input name="cert" type="text" class="text_cray" style="width:100px" value="${sessionScope.listUser.cert }">
        </label></td>
        <td width="8%" align="center" class="text_cray1">旅客类型</td>
        <td width="13%" align="left" class="text_blod"><label>
          <select class="text_cray" id="passengerType" name="userType" style="width:100px">
      ...
      <tr>
        ...
        <table width="553" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#dadada" bgcolor="#FFFFFF">
          ...
          <tr align="center">
            <td height="15" colspan="7" bordercolor="#FFFFFF" bgcolor="#FFFFFF"   class="text_cray1"><img src="../img/line1.jpg" width="790" height="6"></td>
          </tr>
          <c:forEach items="${list }" var="e" varStatus="status">
          <tr align="center" bgcolor="${status.index%2==0?'#FFFFFF':'#cccccc' }">
            <td bordercolor="#FFFFFF"   class="text_cray1">
            <input type="checkbox" name="checkbox" value="${e.id }" ${e.id==sessionScope.user.id?"disabled":"" }>
            </td>
